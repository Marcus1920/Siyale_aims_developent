<!-- Modal Default -->
<div class="modal fade modalAddMeetingFilesModal" id="modalAddMeetingFilesModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="closeMeetingMinutesFiles" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Attach Case File</h4>
            </div>
            <div class="modal-body">

                {!! Form::open(['url' => 'addMeetingMinutesFile', 'method' => 'post', 'class' => 'form-horizontal', 'id'=>"addMeetingMinutesFileForm",'files' => 'true' ]) !!}
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <a type="#" id='submitAddMeetingMinutesFileForm' class="btn btn-sm">Attach File</a>
                    </div>
                </div>
